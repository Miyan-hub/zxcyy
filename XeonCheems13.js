               ...
               XeonBotInc.sendMessage(m.chat, {
                  ...
                  contextInfo: {
                     externalAdReply: {
                        ...
                        body: ownername,
                        thumbnail: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        sourceUrl: "https://wa.me/6283136544642",
                        mediaType: 1,
...
break
            ...
            case 'tagownerbot': {
                XeonBotInc.sendMessage(m.chat, {
                    text: "@6283136544642",
                    mentions: ["6283136544642@s.whatsapp.net"]
                })
                }
            break
            case 'tome':
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"YouTube 🌹\",\"url\":\"https://youtube.com/@ITSZXCYY\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"WhatsApp ☘️\",\"url\":\"https://whatsapp.com/channel/0029VaipR3BAO7RHmjzp0E39\",\"merchant_url\":\"https://www.google.com\"}"
              },              
...
"id":"${prefix}othermenu"}
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"Telegram 💧\",\"url\":\"https://t.me/Taekkgeprekk\",\"merchant_url\":\"https://www.google.com\"}"
              },
...
"sellerJid": "6283136544642@s.whatsapp.net",
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
// XeonBotInc.sendMessage("6283136544642@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e)})
